...
// tooling
// 
export const extractEnvVarsFromShellScript = ({ scriptPath, shellExecutable="bash", debug=false })=>{
...
export const loadShellScript = ({ scriptPath, shellExecutable="bash", debug=false })=>{
